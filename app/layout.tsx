...
export const metadata: Metadata = {
  ...
  keywords: "mystery, audiobooks, stories, reading, Lucien von Castellanos, Thea",
  openGraph: {
    title: "Whirlwind - Timeless Mysteries",
    description: "Read and listen to original mystery stories. Chapter 1 is always free.",
    type: "website",
  },
  icons: {
